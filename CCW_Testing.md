...
2. Watch the following tags in the variable monitor:
   ...
   - `FactorialResult` and `FactorialTime` (should stay at 0 unless `PB2_Num` is 1–7)
...
- Keep `PB2_Num` within 1–7; higher values overflow a 16-bit `INT` and will default the time to 0 ms in this program.
